...
const AcceleratorProgram: React.FC<AcceleratorProgramProps> = ({ formData, setFormData }) => {
  ...
  const benefitOptions = [
    ...
    { value: 'market-access', label: 'Market Access & Customer Development' },
    { value: 'technical', label: 'Technical Resources & Tools' },
    { value: 'legal', label: 'Legal & Regulatory Support' },
    { value: 'office-space', label: 'Office Space & Infrastructure' },
    { value: 'marketing', label: 'Marketing & PR Support' },
    { value: 'partnerships', label: 'Strategic Partnerships' },
    { value: 'talent', label: 'Talent Acquisition & HR' },
    { value: 'product', label: 'Product Development Support' },
    { value: 'connections', label: 'Investor & VC Connections' },
    { value: 'team-building', label: 'Team Building & Leadership' }
  ];
          ...
          <div className="space-y-4 pl-4 border-l-2 border-red-200">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Enter the name(s) of the accelerator(s)"
                required
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Fall 2023, Batch 5"
                  required
                  className="border-gray-300 focus:border-red-500 focus:ring-red-500"
                />
              </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="e.g., Mentorship, office space, funding"
                rows={3}
                className="border-gray-300 focus:border-red-500 focus:ring-red-500"
              />
            </div>
          ...
          <div className="space-y-4 pl-4 border-l-2 border-red-200">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Enter the deadline(s) for the application(s)"
                required
                className="border-gray-300 focus:border-red-500 focus:ring-red-500"
              />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {benefitOptions.map((benefit) => (
              <div key={benefit.value} className="flex items-center space-x-2">
                <Checkbox
                  id={benefit.value}
                  checked={(formData.soughtBenefits as string[]).includes(benefit.value)}
                  onCheckedChange={(checked) => handleArrayChange('soughtBenefits', benefit.value, checked as boolean)}
                />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Textarea
            ...
            placeholder="e.g., Raise $2M Series A, launch in 3 new markets, hire 10 engineers..."
            rows={4}
            required
            className="border-gray-300 focus:border-red-500 focus:ring-red-500"
          />
